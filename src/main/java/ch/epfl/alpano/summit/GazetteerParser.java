...
public final class GazetteerParser {
	 ...
	 * 
	 * @param line La ligne extraite du fichier.
	 * 
	 ...
	 * 
	 * @param degrees String représentant l'angle sous le format "xxx:xx:xx"
	 * 
	 * @return L'angle en radians.
	 * 
	 * @throws NumberFormatException          si au moins une partie de l'angle
	 *                                        n'est pas composée de nombres.
	 ...
	 * 
	 * @throws NumberFormatException          si au moins une partie de l'un des
	 *                                        deux angles n'est pas composée de
	 *                                        nombres.
	 * @throws ArrayIndexOutOfBoundsException si l'un des deux angles est composé de
	 *                                        moins de 3 valeurs.
	 */
	private static GeoPoint getPoint(final String lon, final String lat)
			throws NumberFormatException, ArrayIndexOutOfBoundsException {
	 ...
	 * 
	 * @param file Le fichier contenant les sommets alpins.
	 * 
	 * @return Une liste immuable des sommets alpins.
	 * 
	 * @throws IOException s'il y a un problème à la lecture du fichier ou si le
	 *                     fichier n'est pas conforme aux restrictions.
	 */
	public static List<Summit> readSummitsFrom(final File file) throws IOException {
		final var summits = new ArrayList<Summit>();

		try (final var b = new BufferedReader(new InputStreamReader(new FileInputStream(file), US_ASCII))) {
			String s;
