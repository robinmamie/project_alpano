...
public interface Distance {
	 ...
	 * 
	 * @param distanceInMeters La distance terrestre en mètres.
	 * 
	 * @return Le nombre de radians correspondant à la distance en mètres donnée en
	 *         paramètre.
	 */
	static double toRadians(final double distanceInMeters) {
		return distanceInMeters / EARTH_RADIUS;
	}

	/**
	 * Transforme les radians déterminant une distance inscrite dans un grand cercle
	 * sur la surface de la Terre en mètres.
	 * 
	 * @param distanceInRadians La distance terrestre en radians.
	 * 
	 * @return La distance en mètres correspondant au nombre de radians donné en
	 *         paramètre.
	 */
	static double toMeters(final double distanceInRadians) {
