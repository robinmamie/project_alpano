...
public interface Azimuth {
	...
	/**
	 * Vérifie si l'azimut est sous forme canonique (compris entre 0 inclus et 2Pi
	 * exclu).
	 * 
	 * @param azimuth L'azimut dont on souhaite savoir s'il est sous forme
	 *                canonique.
	 * 
	 * @return True si l'azimut est sous forme canonique.
	 */
	static boolean isCanonical(final double azimuth) {
	 ...
	 * exclu).
	 * 
	 * @param azimuth L'azimut dont on veut connaître la forme canonique.
	 * 
	 * @return La forme canonique de l'azimut passé en argument.
	 */
	static double canonicalize(final double azimuth) {
	 ...
	 * 
	 * @param azimuth L'azimut dont on veut connaître la valeur en tant qu'angle
	 *                mathématique.
	 * 
	 ...
	 *                                  canonique.
	 */
	static double toMath(final double azimuth) {
	 ...
	 * 
	 * @param angle L'angle mathématique dont on veut connaître la valeur en tant
	 *              qu'azimut.
	 * 
	 ...
	 *                                  canonique.
	 */
	static double fromMath(final double angle) {
		checkArgument(isCanonical(angle), "The given angle is not in canonical form.");
	 ...
	 * trouve l'azimut.
	 * 
	 * @param azimuth L'azimut qui servira au calcul de l'octant.
	 ...
	 * 
	 * @return La chaîne de caractère correspondant à l'octant dans lequel se trouve
	 *         l'azimut passé en argument.
	 * 
	 * @throws IllegalArgumentException si l'azimut donné n'est pas sous forme
	 *                                  canonique.
	 */
	static String toOctantString(final double azimuth, final String n, final String e, final String s, String w) {
		checkArgument(isCanonical(azimuth), "The given azimuth is not in canonical form.");

		final var answer = new StringBuilder();
		final var fieldSize = THREE_EIGHTH_PI;
