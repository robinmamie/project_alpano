...
final class CompositeDiscreteElevationModel implements DiscreteElevationModel {
	 ...
	 * autres MNT.
	 * 
	 * @param dem1 Premier MNT
	 * @param dem2 Second MNT
	 * 
	 * @throws NullPointerException si l'un des deux MNT passés en argument est
	 *                              null.
	 */
	public CompositeDiscreteElevationModel(final DiscreteElevationModel dem1, final DiscreteElevationModel dem2) {
