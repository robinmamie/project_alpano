...
public interface DiscreteElevationModel {
	 ...
	 * 
	 * @param angle Un angle en radians.
	 * 
	 * @return L'index correspondant à l'angle.
	 */
	static double sampleIndex(final double angle) {
	 ...
	 * 
	 * @throws IllegalArgumentException si l'index ne fait pas partie de l'étendue
	 *                                  du MNT.
	 */
	 ...
	 * l'argument donné.
	 * 
	 * @param that L'autre instance de DiscreteElevationModel.
	 * 
	 * @return L'union du récepteur et de l'argument <i>that</i>.
	 * 
	 * @throws IllegalArgumentException si l'étendue des deux MNT ne sont pas
	 *                                  unionables.
	 */
	default DiscreteElevationModel union(final DiscreteElevationModel that) {
		checkArgument(this.extent().isUnionableWith(that.extent()), "The provided DEMs are not unionable.");
