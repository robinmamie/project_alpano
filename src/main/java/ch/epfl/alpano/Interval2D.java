...
public record Interval2D(Interval1D iX, Interval1D iY) {
	 ...
	 * bidimensionnels.
	 * 
	 * @param that L'autre intervalle bidimensionnel.
	 * 
	 * @return La taille de l'intersection entre les deux intervalles
	 *         bidimensionnels.
	 */
	public int sizeOfIntersectionWith(final Interval2D that) {
	 ...
	 */
	public boolean isUnionableWith(final Interval2D that) {
	 ...
	 * 
	 * @throws IllegalArgumentException si les deux intervalles bidimensionnel ne
	 *                                  sont pas unionables.
	 */
	...
	public boolean equals(final Object thatO) {
		return thatO instanceof Interval2D that && this.iX().equals(that.iX()) && this.iY().equals(that.iY());
	}
