...
public final class LabeledListStringConverter extends StringConverter<Integer> {
	 ...
	 * entiers.
	 * 
	 * @param values Les valeurs prédéfinies de chaînes de caractères.
	 */
	public LabeledListStringConverter(final String... values) {
		this.values = unmodifiableList(new ArrayList<>(asList(values)));
	}

	@Override
	public Integer fromString(final String arg0) {
